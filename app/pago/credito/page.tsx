...
export default function CreditoPage() {
  const [monto] = useState<number>(96.20);
  ...
  // redirige a la página /pago/revisar
  const handleNext = () => {
    if (
      !form.tarjeta ||
      !form.titular ||
        ...
        <section className="order-2 md:order-1 bg-white rounded-md border border-[#ddd] p-6 shadow-sm">
          ...
          <form onSubmit={(e) => e.preventDefault()} className="space-y-5">
            ...
            <div className="relative">
              <label className="block text-[14px] font-medium text-[#111] mb-1">Número de tarjeta</label>
              <div className="relative">
                <input
                  type="text"
                  name="tarjeta"
            ...
            {/* TITULAR */}
            <div>
              <label className="block text-[14px] font-medium text-[#111] mb-1">Nombre del titular</label>
              <input
                type="text"
                name="titular"
                ...
                required
              />
              <p className="text-[13px] text-[#666] mt-1">Como aparece en la tarjeta.</p>
            </div>

            {/* 🔹 VENCIMIENTO Y CVV */}
            <div className="flex gap-3">
              <div className="flex-1">
                <label className="block text-[14px] font-medium text-[#111] mb-1">Vencimiento</label>
                <input
                  type="text"
                  name="vencimiento"
                  placeholder="MM/AA"
              ...
              <div className="flex-1">
                <label className="block text-[14px] font-medium text-[#111] mb-1">Código de seguridad</label>
                <div className="relative">
                  <input
                    type="text"
                    name="cvv"
            ...
            {/* DOCUMENTO */}
            <div>
              <label className="block text-[14px] font-medium text-[#111] mb-1">Documento del titular</label>
                ...
                <div className="relative w-[150px]">
                  ...
                  >
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="none" viewBox="0 0 20 20">
                      <path d="M6 8l4 4 4-4" stroke="#333" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </button>
