...
function PagoContent() {
  ...
  const monto = montoParam ? parseFloat(montoParam) : 96.20;
          ...
          <div className="space-y-3">
            ...
            <div className="bg-white rounded-md border border-[#ddd] overflow-hidden">
              {[
                ...
                <button
                  key={m.label}
                  onClick={() => router.push(`${m.path}?monto=${monto}`)} // ✅ pasa el monto a las subpáginas
...
// ✅ Envolvemos el componente dentro de un Suspense
